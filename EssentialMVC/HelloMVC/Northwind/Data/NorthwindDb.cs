...
namespace HelloMVC.Northwind.Data
{
    public partial class NorthwindDb : DbContext
    {
        ...
        public DbSet<SalesBYCategoryResult> SalesByCategoryResult { get; set; }
        public IQueryable<SalesBYCategoryResult> sp_SalesByCategory(string name)
        {
            return Set<SalesBYCategoryResult>().FromSqlInterpolated($"EXEC SalesByCategory {name}, '1996'");
        }
        public void sp_IncPrice()
        {
            Database.ExecuteSqlInterpolated($"EXEC IncPrice");
        }
        // end store procedure
...
#warning        To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        {
            modelBuilder.Entity<SalesBYCategoryResult>().HasNoKey();
