...
namespace HelloMVC.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Details(Guid? id)
        {
            ...
            //use Single when fu=ind with primary key
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Name,Price,ImageUrl,Comment")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
